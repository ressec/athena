...
/**
 * Unchecked exception thrown to indicate an error occurred while processing a {@link Command}.
 * <hr>
...
public class CommandException extends AbstractCheckedException
{
	...
	/**
	 * Exception thrown to indicate an error occurred while processing a {@link Command}.
	 */
