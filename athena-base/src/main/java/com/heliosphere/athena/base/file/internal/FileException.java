...
/**
 * checked exception thrown to indicate an error occurred while processing a file.
 * <hr>
...
public class FileException extends AbstractCheckedException
{
	...
	/**
	 * Exception thrown to indicate an error occurred while processing a file.
	 */
	 ...
	 */
	public FileException(final Enum<? extends IBundle> key)
	{
		super(key);
	}
	 ...
	 * message.
	 */
	public FileException(final Enum<?> key, final Object... parameters)
	{
