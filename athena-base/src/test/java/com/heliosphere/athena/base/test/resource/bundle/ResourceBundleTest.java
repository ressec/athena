 ...
 * ---------------------------------------------------------------------------
 */
package com.heliosphere.athena.base.test.resource.bundle;
...
/**
 * A test case for the {@link BundleAthenaBase} class using the {@link ResourceBundleManager} class.
 * <hr>
...
public final class ResourceBundleTest
{
	 ...
	 */
	private static final String DUMMY_ENGLISH = "A test message from component: athena-base";

	/**
	 * Dummy message in french.
	 */
	private static final String DUMMY_FRENCH = "Un message de test du composant: athena-base";

	/**
	 * Dummy message in german.
	 */
	private static final String DUMMY_GERMAN = "Ein Test Nachricht von der Komponente: athena-base";

	/**
	 * Dummy message in spanish.
	 */
	private static final String DUMMY_SPANISH = "Un mensaje de prueba a partir del componente: athena-base";

	/**
	 * Dummy message in italian.
	 */
	private static final String DUMMY_ITALIAN = "Un messaggio di prova dal componente: athena-base";
	...
	public final void registerBundleByEnumClassInEnglish()
	{
		...
		ResourceBundleManager.register(BundleAthenaBase.class);
	...
	public final void retrieveDummyMessageInEnglish()
	{
		try
		{
			...
			Assert.assertTrue("Not the english dummy message!", Collator.getInstance(english).equals(ResourceBundleManager.getMessage(BundleAthenaBase.TestDummy), DUMMY_ENGLISH));
	...
	public final void retrieveDummyMessageInFrench()
	{
		try
		{
			...
			Assert.assertTrue("Not the french dummy message!", Collator.getInstance(french).equals(ResourceBundleManager.getMessage(BundleAthenaBase.TestDummy), DUMMY_FRENCH));
		}
		catch (final ResourceException e)
		{
			fail(e.getLocalizedMessage());
	...
	public final void retrieveDummyMessageInGerman()
	{
		try
		{
			...
			Assert.assertTrue("Not the german dummy message!", Collator.getInstance(german).equals(ResourceBundleManager.getMessage(BundleAthenaBase.TestDummy), DUMMY_GERMAN));
		}
		catch (final ResourceException e)
		{
			fail(e.getLocalizedMessage());
	...
	public final void retrieveDummyMessageInSpanish()
	{
		try
		{
			...
			Assert.assertTrue("Not the spanish dummy message!", Collator.getInstance(spanish).equals(ResourceBundleManager.getMessage(BundleAthenaBase.TestDummy), DUMMY_SPANISH));
		}
		catch (final ResourceException e)
		{
			fail(e.getLocalizedMessage());
	...
	public final void retrieveDummyMessageInItalian()
	{
		try
		{
			...
			Assert.assertTrue("Not the italian dummy message!", Collator.getInstance(italian).equals(ResourceBundleManager.getMessage(BundleAthenaBase.TestDummy), DUMMY_ITALIAN));
		}
		catch (final ResourceException e)
		{
			fail(e.getLocalizedMessage());
